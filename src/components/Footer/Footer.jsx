	...
	return (
		<div className=" bg-neutral text-neutral-content">
			<footer className="px-4 divide-y">
				<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
					<div className="lg:w-1/3">
						<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
							...
							<Link to={'/'} className="btn bg-neutral"><span className="self-center text-2xl text-white hover:text-black font-semibold">Shelter<span className="text-purple-500">Zone</span></span></Link>
						</a>
					</div>
					<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
						...
						<div className="space-y-3 font-bold">
							...
							<div className="flex justify-start space-x-3">
								...
								<Link title="GitHub" to={'https://github.com/RashedulHaqueRasel1'} className="flex items-center p-1">
				...
				<div className="py-6 text-sm text-center dark:text-gray-600 font-bold">© 2024 Company Co. All rights reserved.</div>
			</footer>
		</div>
	);
};
