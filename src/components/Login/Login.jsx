...
const Login = () => {
    ...
    const { createInUser, singWithGoogle, singWithGithub } = useContext(AuthContext)
        ...
        <div>
            ...
            <div className="w-full card shrink-0 mt-12 mb-16  max-w-sm shadow-2xl bg-base-100   p-8 space-y-3 rounded-xl container mx-auto" style={{ boxShadow: 'rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px' }} data-aos="fade-up" data-aos-duration="2000">
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    <div className="space-y-1 text-sm" data-aos="fade-up" data-aos-duration="2500">
                ...
                <div className="flex justify-center space-x-4" data-aos="fade-up" data-aos-duration="3000">
                    <button aria-label="Log in with Google" onClick={handleGoogleSignIn} className="p-4   rounded-3xl bg-purple-500 hover:bg-transparent hover:outline text-white hover:text-black mr-3" >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                            <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                        </svg>
                    </button>
                   
                    <button onClick={handleWithGithubLogin} aria-label="Log in with GitHub" className="p-4   rounded-3xl bg-purple-500 hover:bg-transparent hover:outline text-white hover:text-black mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                    ...
                    <button aria-label="Log in with Twitter" className="p-4   rounded-3xl bg-purple-500 hover:bg-transparent hover:outline text-white hover:text-black mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
